                                    ...
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-12 d-flex flex-column justify-content-between border-container-lg">
                                            <div class="user-avatar-section">
                                                ...
                                                <div class="col-lg-6">
                                                    <img class="img-fluid rounded" style="height: 150px;width: 100%;" src="{{$meal->image_url}}" height="104" width="104" alt="User avatar" />
                                                </div>    
                                                <div class="col-lg-6">
                                                    <div class="d-flex flex-column ml-1">
                                                        ...
                                                        <div class="d-flex flex-wrap">
                                                            <a href="{{route('admin.meals.edit',[$meal->id])}}" class="btn btn-primary">Edit</a>
                                        ...
                                        <div class="col-xl-6 col-lg-12 mt-2 mt-xl-0">
                                            <div class="user-info mb-1">
                                                ...
                                                <p class="card-text" style="text-align: justify;">{{$meal->description}}</p>
                                            </div>
